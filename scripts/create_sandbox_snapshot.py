"""Create a LangSmith sandbox snapshot for alephat."""
...
DEFAULT_IMAGE = "johanneslangchain/alephat-sandbox:gh-cli-amd64"
...
def main() -> None:
    ...
    parser.add_argument(
        "--name", default="alephat-gh-amd64", help="Snapshot name (default: alephat-gh-amd64)"
    )
    parser.add_argument(
