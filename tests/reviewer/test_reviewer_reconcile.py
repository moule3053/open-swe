            ...
            [
                {
                    ...
                    "is_resolved": True,
                    "is_outdated": False,
                    "comments": [{"id": 11, "author": "alephat[bot]", "body": "bug"}],
                }
            ],
        )
            ...
            [
                {
                    ...
                    "is_resolved": False,
                    "is_outdated": True,
                    "comments": [{"id": 11, "author": "alephat[bot]", "body": marker}],
                },
                {
                    "id": "THREAD_OPEN",
                    "is_resolved": False,
                    "is_outdated": False,
                    "comments": [{"id": 12, "author": "alephat[bot]", "body": marker}],
                },
            ],
        )
            ...
            [
                {
                    ...
                    "is_outdated": False,
                    "comments": [
                        {"id": 11, "author": "alephat[bot]", "body": "bug"},
                        {
                            "id": 12,
                            "author": "human",
